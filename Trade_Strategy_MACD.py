...
def trade_strategy_macd(max_allow_score):
	#print(ind.version)
...
#g = float("{:.2f}".format(x))
		...
		try:
			...
			#continue
			data_macd_5M_buy = {'apply_to': 'close','tp' : 0.02, 'st' : 0.3,
		...
		try:
			...
			#continue
			data_macd_5M_sell = {'apply_to': 'close','tp' : 0.02, 'st' : 0.3,
			'macd_fast': 8 , 'macd_slow': 18, 'macd_signal': 6
			,'diff_plus':0 , 'diff_minus': 0,'score': 0}
		...
		try:
			...
			#continue
			data_macd_30M_buy = {'apply_to': 'close','tp' : 0.02, 'st' : 0.3,
			'macd_fast': 8 , 'macd_slow': 18, 'macd_signal': 6
			,'diff_plus':0 , 'diff_minus': 0,'score': 0}
		...
		try:
			...
			#continue
			data_macd_30M_sell = {'apply_to': 'close','tp' : 0.02, 'st' : 0.3,
			'macd_fast': 8 , 'macd_slow': 18, 'macd_signal': 6
			,'diff_plus':0 , 'diff_minus': 0,'score': 0}
		...
		try:
			...
			#continue
			data_macd_1H_buy = {'apply_to': 'close','tp' : 0.02, 'st' : 0.3,
			'macd_fast': 8 , 'macd_slow': 18, 'macd_signal': 6
			,'diff_plus':0 , 'diff_minus': 0,'score': 0}
		...
		try:
			...
			#continue
			data_macd_1H_sell = {'apply_to': 'close','tp' : 0.02, 'st' : 0.3,
			'macd_fast': 8 , 'macd_slow': 18, 'macd_signal': 6
			,'diff_plus':0 , 'diff_minus': 0,'score': 0}
	...
	#help(ind.macd)
		try:
			...
			signal_cross_30M_buy = cross_macd(macd_30M_buy,macds_30M_buy,macdh_30M_buy,sym.name,data_macd_30M_buy['diff_minus'],data_macd_30M_buy['diff_plus'])
		...
		try:
			...
			signal_cross_30M_sell = cross_macd(macd_30M_sell,macds_30M_sell,macdh_30M_sell,sym.name,data_macd_30M_sell['diff_minus'],data_macd_30M_sell['diff_plus'])
		...
		try:
			...
			signal_cross_5M_buy = cross_macd(macd_5M_buy,macds_5M_buy,macdh_5M_buy,sym.name,data_macd_5M_buy['diff_plus'],data_macd_5M_buy['diff_minus'])
		...
		try:
			...
			signal_cross_5M_sell = cross_macd(macd_5M_sell,macds_5M_sell,macdh_5M_sell,sym.name,data_macd_5M_sell['diff_plus'],data_macd_5M_sell['diff_minus'])
		...
		try:
			...
			signal_cross_1H_buy = cross_macd(macd_1H_buy,macds_1H_buy,macdh_1H_buy,sym.name,data_macd_1H_buy['diff_minus'],data_macd_1H_buy['diff_plus'])
		...
		try:
			...
			signal_cross_1H_sell = cross_macd(macd_1H_sell,macds_1H_sell,macdh_1H_sell,sym.name,data_macd_1H_sell['diff_minus'],data_macd_1H_sell['diff_plus'])
		...
		try:
			...
			macd_all_5M30M_buy_5M = ind.macd(symbol_data_5M[sym.name][data_macd_5M30M_buy['apply_to5M']],fast=data_macd_5M30M_buy['macd_fast5M'], slow=data_macd_5M30M_buy['macd_slow5M'],signal=data_macd_5M30M_buy['macd_signal5M'], verbose=True)

			macd_5M30M_buy_5M = macd_all_5M30M_buy_5M[macd_all_5M30M_buy_5M.columns[0]]
			macdh_5M30M_buy_5M = macd_all_5M30M_buy_5M[macd_all_5M30M_buy_5M.columns[1]]
			macds_5M30M_buy_5M = macd_all_5M30M_buy_5M[macd_all_5M30M_buy_5M.columns[2]]
			signal_cross_5M30M_buy_5M = cross_macd(macd_5M30M_buy_5M,macds_5M30M_buy_5M,macdh_5M30M_buy_5M,sym.name,data_macd_5M30M_buy['diff_plus5M'],data_macd_5M30M_buy['diff_minus5M'])

			#*********************---------------------*************/////////////*************************************************

		except:
			print('5M30M 5M Buy Macd Wrong!!')

		try:
			# *******************++++++++++++ MACD Buy 30M************************************************************

			macd_all_5M30M_buy_30M = ind.macd(symbol_data_30M[sym.name][data_macd_5M30M_buy['apply_to30M']],fast=data_macd_5M30M_buy['macd_fast30M'], slow=data_macd_5M30M_buy['macd_slow30M'],signal=data_macd_5M30M_buy['macd_signal30M'], verbose=True)

			macd_5M30M_buy_30M = macd_all_5M30M_buy_30M[macd_all_5M30M_buy_30M.columns[0]]
			macdh_5M30M_buy_30M = macd_all_5M30M_buy_30M[macd_all_5M30M_buy_30M.columns[1]]
			macds_5M30M_buy_30M = macd_all_5M30M_buy_30M[macd_all_5M30M_buy_30M.columns[2]]

			signal_cross_5M30M_buy_30M = cross_macd(macd_5M30M_buy_30M,macds_5M30M_buy_30M,macdh_5M30M_buy_30M,sym.name,data_macd_5M30M_buy['diff_minus30M'],data_macd_5M30M_buy['diff_plus30M'])

			#*********************---------------------*************/////////////*************************************************

		except:
			print('5M30M 30M Buy Macd Wrong!!')
		#********************************************///////////////////****************************************************************
		#///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		try:
			...
			macd_all_5M30M_sell_5M = ind.macd(symbol_data_5M[sym.name][data_macd_5M30M_sell['apply_to5M']],fast=data_macd_5M30M_sell['macd_fast5M'], slow=data_macd_5M30M_sell['macd_slow5M'],signal=data_macd_5M30M_sell['macd_signal5M'], verbose=True)

			macd_5M30M_sell_5M = macd_all_5M30M_sell_5M[macd_all_5M30M_sell_5M.columns[0]]
			macdh_5M30M_sell_5M = macd_all_5M30M_sell_5M[macd_all_5M30M_sell_5M.columns[1]]
			macds_5M30M_sell_5M = macd_all_5M30M_sell_5M[macd_all_5M30M_sell_5M.columns[2]]
			signal_cross_5M30M_sell_5M = cross_macd(macd_5M30M_sell_5M,macds_5M30M_sell_5M,macdh_5M30M_sell_5M,sym.name,data_macd_5M30M_sell['diff_plus5M'],data_macd_5M30M_sell['diff_minus5M'])

			#*********************---------------------*************/////////////*************************************************

		except:
			print('5M30M 5M sell Macd Wrong!!')

		try:
			# *******************++++++++++++ MACD Buy 30M************************************************************

			macd_all_5M30M_sell_30M = ind.macd(symbol_data_30M[sym.name][data_macd_5M30M_sell['apply_to30M']],fast=data_macd_5M30M_sell['macd_fast30M'], slow=data_macd_5M30M_sell['macd_slow30M'],signal=data_macd_5M30M_sell['macd_signal30M'], verbose=True)

			macd_5M30M_sell_30M = macd_all_5M30M_sell_30M[macd_all_5M30M_sell_30M.columns[0]]
			macdh_5M30M_sell_30M = macd_all_5M30M_sell_30M[macd_all_5M30M_sell_30M.columns[1]]
			macds_5M30M_sell_30M = macd_all_5M30M_sell_30M[macd_all_5M30M_sell_30M.columns[2]]

			signal_cross_5M30M_sell_30M = cross_macd(macd_5M30M_sell_30M,macds_5M30M_sell_30M,macdh_5M30M_sell_30M,sym.name,data_macd_5M30M_sell['diff_minus30M'],data_macd_5M30M_sell['diff_plus30M'])

			#*********************---------------------*************/////////////*************************************************

		except:
			print('5M30M 30M sell Macd Wrong!!')
		...
		try:
			...
			macd_all_porro_buy_5M = ind.macd(symbol_data_5M[sym.name][data_macd_porro_buy['apply_to5M']],fast=data_macd_porro_buy['macd_fast5M'], slow=data_macd_porro_buy['macd_slow5M'],signal=data_macd_porro_buy['macd_signal5M'], verbose=True)

			macd_porro_buy_5M = macd_all_porro_buy_5M[macd_all_porro_buy_5M.columns[0]]
			macdh_porro_buy_5M = macd_all_porro_buy_5M[macd_all_porro_buy_5M.columns[1]]
			macds_porro_buy_5M = macd_all_porro_buy_5M[macd_all_porro_buy_5M.columns[2]]
			signal_cross_porro_buy_5M = cross_macd(macd_porro_buy_5M,macds_porro_buy_5M,macdh_porro_buy_5M,sym.name,data_macd_porro_buy['diff_plus5M'],data_macd_porro_buy['diff_minus5M'])

			#*********************---------------------*************/////////////*************************************************

		except:
			print('Porro 5M Buy Macd Wrong!!')

		try:
			# *******************++++++++++++ MACD Buy 30M************************************************************

			macd_all_porro_buy_30M = ind.macd(symbol_data_30M[sym.name][data_macd_porro_buy['apply_to30M']],fast=data_macd_porro_buy['macd_fast30M'], slow=data_macd_porro_buy['macd_slow30M'],signal=data_macd_porro_buy['macd_signal30M'], verbose=True)

			macd_porro_buy_30M = macd_all_porro_buy_30M[macd_all_porro_buy_30M.columns[0]]
			macdh_porro_buy_30M = macd_all_porro_buy_30M[macd_all_porro_buy_30M.columns[1]]
			macds_porro_buy_30M = macd_all_porro_buy_30M[macd_all_porro_buy_30M.columns[2]]

			signal_cross_porro_buy_30M = cross_macd(macd_porro_buy_30M,macds_porro_buy_30M,macdh_porro_buy_30M,sym.name,data_macd_porro_buy['diff_minus30M'],data_macd_porro_buy['diff_plus30M'])

			#*********************---------------------*************/////////////*************************************************

		except:
			print('Porro 30M Buy Macd Wrong!!')

		try:
			# *******************++++++++++++ MACD Buy 1H************************************************************

			macd_all_porro_buy_1H = ind.macd(symbol_data_1H[sym.name][data_macd_porro_buy['apply_to1H']],fast=data_macd_porro_buy['macd_fast1H'], slow=data_macd_porro_buy['macd_slow1H'],signal=data_macd_porro_buy['macd_signal1H'], verbose=True)

			macd_porro_buy_1H = macd_all_porro_buy_1H[macd_all_porro_buy_1H.columns[0]]
			macdh_porro_buy_1H = macd_all_porro_buy_1H[macd_all_porro_buy_1H.columns[1]]
			macds_porro_buy_1H = macd_all_porro_buy_1H[macd_all_porro_buy_1H.columns[2]]
			signal_cross_porro_buy_1H = cross_macd(macd_porro_buy_1H,macds_porro_buy_1H,macdh_porro_buy_1H,sym.name,data_macd_porro_buy['diff_minus1H'],data_macd_porro_buy['diff_plus1H'])

			#*********************---------------------*************/////////////*************************************************

		except:
			print('Porro 1H Buy Macd Wrong!!')
		...
		try:
			...
			macd_all_porro_sell_5M = ind.macd(symbol_data_5M[sym.name][data_macd_porro_sell['apply_to5M']],fast=data_macd_porro_sell['macd_fast5M'], slow=data_macd_porro_sell['macd_slow5M'],signal=data_macd_porro_sell['macd_signal5M'], verbose=True)

			macd_porro_sell_5M = macd_all_porro_sell_5M[macd_all_porro_sell_5M.columns[0]]
			macdh_porro_sell_5M = macd_all_porro_sell_5M[macd_all_porro_sell_5M.columns[1]]
			macds_porro_sell_5M = macd_all_porro_sell_5M[macd_all_porro_sell_5M.columns[2]]
			signal_cross_porro_sell_5M = cross_macd(macd_porro_sell_5M,macds_porro_sell_5M,macdh_porro_sell_5M,sym.name,data_macd_porro_sell['diff_plus5M'],data_macd_porro_sell['diff_minus5M'])

			#*********************---------------------*************/////////////*************************************************

		except:
			print('Porro5M sell Macd Wrong!!')

		try:
			# *******************++++++++++++ MACD Buy 30M************************************************************

			macd_all_porro_sell_30M = ind.macd(symbol_data_30M[sym.name][data_macd_porro_sell['apply_to30M']],fast=data_macd_porro_sell['macd_fast30M'], slow=data_macd_porro_sell['macd_slow30M'],signal=data_macd_porro_sell['macd_signal30M'], verbose=True)

			macd_porro_sell_30M = macd_all_porro_sell_30M[macd_all_porro_sell_30M.columns[0]]
			macdh_porro_sell_30M = macd_all_porro_sell_30M[macd_all_porro_sell_30M.columns[1]]
			macds_porro_sell_30M = macd_all_porro_sell_30M[macd_all_porro_sell_30M.columns[2]]

			signal_cross_porro_sell_30M = cross_macd(macd_porro_sell_30M,macds_porro_sell_30M,macdh_porro_sell_30M,sym.name,data_macd_porro_sell['diff_minus30M'],data_macd_porro_sell['diff_plus30M'])

			#*********************---------------------*************/////////////*************************************************

		except:
			print('Porro 30M sell Macd Wrong!!')

		try:
			# *******************++++++++++++ MACD Buy 1H************************************************************

			macd_all_porro_sell_1H = ind.macd(symbol_data_1H[sym.name][data_macd_porro_sell['apply_to1H']],fast=data_macd_porro_sell['macd_fast1H'], slow=data_macd_porro_sell['macd_slow1H'],signal=data_macd_porro_sell['macd_signal1H'], verbose=True)

			macd_porro_sell_1H = macd_all_porro_sell_1H[macd_all_porro_sell_1H.columns[0]]
			macdh_porro_sell_1H = macd_all_porro_sell_1H[macd_all_porro_sell_1H.columns[1]]
			macds_porro_sell_1H = macd_all_porro_sell_1H[macd_all_porro_sell_1H.columns[2]]
			signal_cross_porro_sell_1H = cross_macd(macd_porro_sell_1H,macds_porro_sell_1H,macdh_porro_sell_1H,sym.name,data_macd_porro_sell['diff_minus1H'],data_macd_porro_sell['diff_plus1H'])

			#*********************---------------------*************/////////////*************************************************

		except:
			print('Porro 1H sell Macd Wrong!!')
...
#print("macd = ",macd[macd.columns[2]])#signal
		...
		try:
			...
			print('signal problem 5M30M BUY MACD!!!')
		...
		try:
			...
			print('signal problem 5M30M SELL MACD!!!')
		...
		try:
			...
			print('signal problem Porro BUY MACD!!!')
		...
		try:
			...
			print('signal problem Porro SELL MACD!!!')
					...
					#continue
						...
						try:
							...
							if (flag_cross_porro == 'buy'):
								...
								sp_buy = (price - ((((abs(data_macd_porro_buy['st'])) + spred) * price)/100))#(tenkan_5M[chiko_sig_5M[sym.name][len(chiko_sig_5M[sym.name])-1]['number']] - ((0.05 * tenkan_5M[chiko_sig_5M[sym.name][len(chiko_sig_5M[sym.name])-1]['number']])/100))#(price - (((2 + spred) * price)/100))
					...
					#continue
						...
						try:
							...
							if (flag_cross_porro == 'sell'):
								...
								sp_sell = (price + ((((abs(data_macd_porro_sell['st'])) + spred) * price)/100))#(tenkan_5M[chiko_sig_5M[sym.name][len(chiko_sig_5M[sym.name])-1]['number']] + ((0.05 * tenkan_5M[chiko_sig_5M[sym.name][len(chiko_sig_5M[sym.name])-1]['number']])/100))#(price - (((2 + spred) * price)/100))
					...
					#continue
						...
						try:
							...
							if (flag_cross_5M30M == 'buy'):
								...
								sp_buy = (price - ((((abs(data_macd_5M30M_buy['st'])) + spred) * price)/100))
					...
					#continue
						...
						try:
							...
							if (flag_cross_5M30M == 'sell'):
								...
								sp_sell = (price + ((((abs(data_macd_5M30M_sell['st'])) + spred) * price)/100))
					...
					#continue
						...
						try:
							...
							if (flag_cross_1H == 'buy'):
								...
								sp_buy = (price - ((((abs(data_macd_1H_sell['st'])) + spred) * price)/100))
					...
					#continue
						...
						try:
							...
							if (flag_cross_1H == 'sell'):
								...
								sp_sell = (price + ((((abs(data_macd_1H_sell['st'])) + spred) * price)/100))
					...
					#continue
						...
						try:
							...
							if (flag_cross_30M == 'buy'):
								...
								sp_buy = (price - ((((abs(data_macd_30M_buy['st'])) + spred) * price)/100))#(tenkan_30M[chiko_sig_30M[sym.name][len(chiko_sig_30M[sym.name])-1]['number']] - ((0.05 * tenkan_30M[chiko_sig_30M[sym.name][len(chiko_sig_30M[sym.name])-1]['number']])/100))#(price - (((2 + spred) * price)/100))	
					...
					#continue
						...
						try:
							...
							if (flag_cross_30M == 'sell'):
								...
								sp_sell = (price + ((((abs(data_macd_30M_sell['st'])) + spred) * price)/100))#(tenkan_30M[chiko_sig_30M[sym.name][len(chiko_sig_30M[sym.name])-1]['number']] + ((0.05 * tenkan_30M[chiko_sig_30M[sym.name][len(chiko_sig_30M[sym.name])-1]['number']])/100))#(price - (((2 + spred) * price)/100))
					...
					#continue
						...
						try:
							...
							if (flag_cross_5M == 'buy'):
								...
								sp_buy = (price - ((((abs(data_macd_5M_buy['st'])) + spred) * price)/100))
					...
					#continue
						...
						try:
							...
							if (flag_cross_5M == 'sell'):
								...
								sp_sell = (price + ((((abs(data_macd_5M_sell['st'])) + spred) * price)/100))
