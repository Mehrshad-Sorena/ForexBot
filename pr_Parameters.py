...
class Parameters:
	...
	def __init__(self):
		...
		self.elements = dict(
							...
							'ExtremePoints_num_max_5M': 2,
							'ExtremePoints_num_min_5M': 2,
							...
							'TrendLines_num_max_5M': 2,
							'TrendLines_num_min_5M': 2,
							...
							'BestFinder' + '_alpha_low': 0.05,
							'BestFinder' + '_alpha_high': 0.05,
