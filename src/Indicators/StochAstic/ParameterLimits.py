class ParameterLimits:
	...
	def __init__(self):
		...
		self.elements = dict(
							...
							'Divergence_num_exteremes_max_upper': 400,#250,
							...
							'IchimokouFlatLines_tenkan_5M_upper': 30,#108,#500,
							'IchimokouFlatLines_tenkan_5M_lower': 2,

							'IchimokouFlatLines_kijun_5M_upper': 60,#312,#1400,
							'IchimokouFlatLines_kijun_5M_lower': 2,

							'IchimokouFlatLines_senkou_5M_upper': 104,#624,#2500,
							...
							'IchimokouFlatLines_tenkan_1H_upper': 18,#50,
							'IchimokouFlatLines_tenkan_1H_lower': 2,

							'IchimokouFlatLines_kijun_1H_upper': 52,#110,
							'IchimokouFlatLines_kijun_1H_lower': 2,

							'IchimokouFlatLines_senkou_1H_upper': 104,#210,
