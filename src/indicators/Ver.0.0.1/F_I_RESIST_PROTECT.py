...
protect_resist(
				...
				T_4H=False,
				T_1D=False,
				dataset_5M=symbol_data_5M['XAUUSD_i'],
				dataset_15M=symbol_data_1H['XAUUSD_i'],
				dataset_1H=symbol_data_1H['XAUUSD_i'],
				dataset_4H=symbol_data_1H['XAUUSD_i'],
				dataset_1D=symbol_data_1H['XAUUSD_i'],
				plot=False
				)
