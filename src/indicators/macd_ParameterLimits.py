class ParameterLimits:
	...
	def __init__(self):
		...
		self.elements = dict(
							...
							'BestFinder_n_cluster_low_upper': 50,
							'BestFinder_n_cluster_low_lower': 1,

							'BestFinder_n_cluster_high_upper': 50,
							'BestFinder_n_cluster_high_lower': 1,

							'BestFinder_alpha_low_upper': 99,
							'BestFinder_alpha_low_lower': 1,

							'BestFinder_alpha_high_upper': 99,
