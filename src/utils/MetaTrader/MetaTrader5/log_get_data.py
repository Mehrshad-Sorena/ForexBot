...
#relative_path = 'utils/MetaTrader/MetaTrader5'
#path_final = os.path.relpath(full_path, relative_path)
#sys.path.insert(1,path_final)
#sys.path.insert()

from .Config import accountConfig

print(accountConfig(filename=sys.path[1]+'/config.ini'))
	...
	try:
		for i in symbols:
			...
			# convert time in seconds into the datetime format
				...
				#print("some thing wrong log get data genetic!!!",ex)
				pass
	except Exception as ex:
		print("some thing wrong log get data genetic!!!",ex)
